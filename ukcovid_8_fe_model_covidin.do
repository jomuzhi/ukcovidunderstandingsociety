 ...
 *-----------------Macro setup------------------*   
	...
	global weight "betaindin_xw_w0"
		/*(“bl_betaindin_xw”) is included to support inferences about the same population as the
adult web-only survey (“cW_betaindin_xw”) weights.*/
    /*For each wave of the COVID-19 web survey, data users are provided with a single crosssectional
weight (“cW_betaindin_xw”), that adjusts for unequal selection probabilities and
differential nonresponse.*/
	/*Since I focus on the period-specific effect, which aims to be national-representative, just use this one should be good enough*/
	
	*global weight "betaindin_lw_last" 
	/*Such weights are produced for individuals that respond to focal sets of all waves
leading up to and including the final, target wave; sample may be too selective to be adjusted!*/
