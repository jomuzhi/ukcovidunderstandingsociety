...
preserve
  ...
  xtdes
restore
    //23453 in the last wave of main UKHLS
    //19763 answered the Covid survey
*/
  /*
  capture drop agegr
  egen agegr = cut(age), at(16,25,35,45,55,65,75,120)
  table agegr, c(min age max age)
  ta agegr
  table agegr, c(mean swb)  
  table sex, c(mean swb) //women score worse; higher values of depression
  */
  ...
  *Now we have those who are not in COVID but in other UKHLS waves
  ...
  sort pidp waveall
  ta waveall,m //23797 from COVID x-sample, could be merged into UKHLS other waves
