*New sample included, re-asking baseline info, ok
     ...
     *replace working1=0 if keyworksector==-8&working1==1
     ...
     replace working1=1 if furlough==1|furlough==2
     replace working1=0 if furlough==-8&working1==.
...
*Paid work and housework time, childcare time 
    ...
    table parent1, c(mean timeccare) //timeccare asked children aged 16-18 
    order pidp hhcomp* parent1  timeccare
